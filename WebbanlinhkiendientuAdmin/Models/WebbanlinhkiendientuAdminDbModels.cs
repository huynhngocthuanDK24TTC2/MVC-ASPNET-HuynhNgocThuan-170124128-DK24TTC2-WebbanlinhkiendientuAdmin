...
{
    // Class quản lý kết nối Database chính của dự án
    public partial class WebbanlinhkiendientuAdminDbModels : DbContext
    {
        // Constructor: Gọi chuỗi kết nối từ Web.config
        public WebbanlinhkiendientuAdminDbModels()
            : base("name=WebbanlinhkiendientuAdminDbModels")
        {
